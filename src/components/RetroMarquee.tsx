...
export function RetroMarquee({
	...
	return (
		<div
			className={`relative bg-gray-800 border-4 border-gray-600 rounded-lg shadow-2xl p-2 ${className}`}
		>
			...
			<div className="relative bg-gray-950 retro-screen border-2 border-gray-900 overflow-hidden rounded-md">
				...
				<div className="whitespace-nowrap relative z-20">
					<div
						className="marquee flex items-center gap-16"
						style={{ animationDuration: `${speed}s` }}
					>
						<span className={`font-retro ${sizeClass} ${colorClass}`}>
							{text}
						</span>
						<span className={`font-retro ${sizeClass} ${colorClass}`}>
							{text}
