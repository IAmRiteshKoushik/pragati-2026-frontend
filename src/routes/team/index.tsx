			...
			<div className="fixed inset-0 z-0 pointer-events-none">
				...
				<motion.div
					...
					style={{
						...
						backgroundImage:
							"linear-gradient(90deg, #2de2e6 1px, transparent 1px), linear-gradient(#2de2e6 1px, transparent 1px)",
				...
				>
					...
					<div className="lg:hidden relative flex items-center justify-between gap-4 bg-black/60 backdrop-blur-sm p-3 rounded-sm border-2 border-retro-cyan/50">
						...
						<button
							...
							className="p-3 text-retro-cyan disabled:opacity-30"
						>
							<IoArrowBack />
						</button>
						<div className="flex-1 text-center font-bold text-white uppercase tracking-wider text-sm">
							{verticals[activeIndex]}{" "}
							<span className="text-retro-pink">•</span> TEAM
						</div>
						<button
							type="button"
							onClick={handleNext}
